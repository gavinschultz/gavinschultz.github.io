...
```
0013: BD D7 B2     JSR $17B2   Jump to initialize_video()
```
...
17B5: 86 03        LDA #$03     Set A to 3 (binary 000 0011)
17B7: C6 07        LDB #$07     Set B to 7
17B9: 8D 12        BSR $17CD    Set SAM, 7 bits with mask 000 0011 at address 0xFFC6
```
